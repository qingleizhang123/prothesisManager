<template>
  <div class="main-content">
    ...
    <a-form
      ...
      v-bind="layout"
    >
      <a-form-item ref="name" label="器械名称" name="name" :rules="[{ required: true, message: 'Please input your name!' }]">
        <a-input v-model:value="formState.name" />
      </a-form-item>
      <a-form-item label="器械类型" name="type" :rules="[{ required: true, message: 'Please input your type!' }]">
        <a-select v-model:value="formState.type" placeholder="please select your type">
          <a-select-option :value=-1>-请选择-</a-select-option>
          <a-select-option :value="1">耗材</a-select-option>
          <a-select-option :value="2">骨钉</a-select-option>
          <a-select-option :value="3">假体</a-select-option>
          <a-select-option :value="4">支架</a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item label="器械厂商" name="factory" :rules="[{ required: true, message: 'Please input your factory!' }]">
      ...
      <a-form-item label="器械描述" name="desc">
